...
**query**
```
ремонт электроинструмента воронеж
```
**org_text**
```
Эвис-Моторс центр; Evis-Motors Central; Evis-Motors-Central; Эвис Моторс; Эвис-Моторс; Evis-Motors | Москва, Партийный переулок, 1к58с1 | Автосервис , автотехцентр | Организация занимается автообслуживанием, включая замену масла, диагностику, кузовной ремонт и хранение шин. Отзывы в основном положительные, но есть и критика. Хвалят: профессионализм мастеров, качество обслуживания, вежливость персонала. Критикуют: длительное ожидание, завышенные цены, невнимательность к клиентам...
```
**label**: `0`
