...
* **BERT (cross-encoder)** — `deepvk/RuModernBERT-base`, дообученный как бинарный классификатор пар `[query, org_text]`(Reimers & Gurevych, 2019; Nogueira & Cho, 2019). Обрабатывает все примеры и выдаёт калиброванные вероятности.
